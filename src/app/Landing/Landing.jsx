    ...
    <section className="carousel-section w-full max-w-6xl mt-8 relative">
      ...
      <Slider {...carouselSettings}>
        <div className="relative rounded-lg ">
          <img src="https://storage.googleapis.com/tradeinn-images/images/landing-pages/eng_appleLP-6.jpg" alt="Producto 1" className="w-full rounded-3xl h-58" />
          <div className="">
            <p className=""></p>
          </div>
        </div>
        <div>
          <img src="https://tiendazero.com.uy/wp-content/uploads/Banner-apple-iphone-14.webp" alt="Producto 2" className="w-full rounded-3xl h-58" />
      ...
      <section className="payment-methods bg-gray-900 p-6 w-full max-w-6xl mt-10 rounded-lg">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="payment-card bg-white p-4 rounded-lg shadow-md text-center">
            <img src="//img.freepik.com/vector-premium/icono-billetera-simbolo-dolar-icono-vector-billetera-digital-signo-estilo-lineal-concepto-movil_615232-309.jpg" alt="Efectivo" className="mt-2 w-36 h-34 mx-auto mb-4" />
